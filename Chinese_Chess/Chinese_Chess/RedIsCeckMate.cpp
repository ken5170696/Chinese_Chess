...
RedIsCeckMate::RedIsCeckMate(StateStack& _stack, StateContext _context)
...
bool RedIsCeckMate::update(sf::Time dt)
{
...
bool RedIsCeckMate::handleEvent(const sf::Event& event)
{
	for (auto& button : mOptions) {
